<!DOCTYPE html>
  <html>
      ...
      <?php 
        ...
        $id_ingre=$_GET['id'];
        $sql_ingre="SELECT `codigo`,`cantidad`,`nombre_ingrediente`,`costo_presentacion`,`costo_unitario`,unidad.des_unidad,unidad.id_unidad FROM `ingredientes` INNER JOIN unidad ON ingredientes.id_unidad = unidad.id_unidad WHERE id_ingredientes = '$id_ingre'  ";
    ...
    <div class="input-field col m6 s12 center">
        <input id="ppresentacion" name="ppresentacion" type="number" class="validate" value="<?php echo $ingre['costo_presentacion'];  ?>" onKeyUp="Suma()" required>
