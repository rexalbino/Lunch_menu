<?php
    ...
    $sql="INSERT INTO `platillo_ingrediente` (`id_relacion`, `id_ingrediente`, `id_platillo`, `peso_bruto`, `peso_neto`, `merma`, `id_tipo_merma`, `coste_unitario`, `coste_neto`, `pax_pesos`, `pax_porciento`) VALUES (NULL, '$id_ingrediente', '$id_platillo', '$id_pesobruto', '$id_pesoneto', '$id_merma', '$id_relacion_merma', '$id_costeunitario', '$id_costeneto', '$id_paxpesos', '0');";
